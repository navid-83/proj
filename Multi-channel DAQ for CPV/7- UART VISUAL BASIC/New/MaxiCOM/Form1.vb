...
Public Class MaxiTester
    ...
    Private Sub Receiver(ByVal sender As Object, ByVal e As SerialDataReceivedEventArgs) Handles COMPort.DataReceived
        ...
        Do
            ...
            stringLogData = stringLogData & stringtoparse & "\n"
    ...
    Private Sub Display()
        ...
        Light.Text = New String(stringtoparse, 4, 2) 'declare a new variable to put the data in
        Temperature.Text = New String(stringtoparse, 10, 3)
        Volt.Text = New String(stringtoparse, 16, 2)
        Current.Text = New String(stringtoparse, 22, 2)
    End Sub
    ...
    Private Sub SaveDa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveDa.Click
        'Dim writein
