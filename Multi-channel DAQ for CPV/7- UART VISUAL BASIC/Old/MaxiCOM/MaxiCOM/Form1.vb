...
Public Class MaxiTester
    ...
    Private Sub Display()
        ...
        Light.Text = New String(stringtoparse, 5, 2) 'declare a new variable to put the data in
        Temperature.Text = New String(stringtoparse, 11, 3)
        Volt.Text = New String(stringtoparse, 17, 2)
